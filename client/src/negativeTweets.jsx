      ...
      <div className="col col-3-of-6" style={{backgroundColor: 'rgba(192, 57, 43, .2)'}}>
        <Tweets>
          <div className="row">
            ...
            <div>
              {this.props.tweets.map((tweet, i) => <Tweet id={i} userClickHandler={this.props.userClickHandler} clickHandler={this.props.clickHandler} dragging={this.props.dragging} type="negativeTweets" key={i} tweet={tweet}/>)}
            </div>
          </div>
        </Tweets>
      </div>
